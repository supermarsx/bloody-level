...
mod tests {
    ...
    #[test]
    fn parses_pt_decimal() {
        assert_eq!(parse_numeric_decimal("13,8"), Some(13.8));
    }
    #[test]
    fn parses_en_decimal() {
        assert_eq!(parse_numeric_decimal("13.8"), Some(13.8));
    }
    #[test]
    fn parses_thousands_pt() {
        assert_eq!(parse_numeric_decimal("1.234,5"), Some(1234.5));
    }
    #[test]
    fn parses_thousands_en() {
        assert_eq!(parse_numeric_decimal("1,234.5"), Some(1234.5));
    }
    #[test]
    fn parses_int() {
        assert_eq!(parse_numeric_decimal("353"), Some(353.0));
    }
    #[test]
    fn parses_lt() {
    ...
    #[test]
    fn parses_gte() {
        assert_eq!(parse_inequality_value(">= 60").map(|(_, v)| v), Some(60.0));
    }
    #[test]
    fn parses_qual() {
    ...
    #[test]
    fn parses_qual_nodia() {
        assert_eq!(
            parse_qualitative_value("Nao detectado"),
            Some("Não detectado")
        );
    }
    ...
    fn rejects_empty_value() {
        assert!(parse_numeric_decimal("").is_none());
    }
    #[test]
    ...
    #[test]
    fn rejects_pure_alphabetic() {
        assert!(parse_numeric_decimal("abc").is_none());
    }
    #[test]
    fn rejects_mixed_alphanumeric() {
        assert!(parse_numeric_decimal("12abc").is_none());
    }
    #[test]
    fn rejects_double_decimal() {
        assert!(parse_numeric_decimal("1..2").is_none());
    }
    #[test]
    ...
    #[test]
    fn rejects_just_a_dot() {
        assert!(parse_numeric_decimal(".").is_none());
    }
    #[test]
    fn rejects_just_a_comma() {
        assert!(parse_numeric_decimal(",").is_none());
    }
    #[test]
    fn rejects_just_a_minus() {
        assert!(parse_numeric_decimal("-").is_none());
    }
    #[test]
    fn rejects_internal_space() {
        assert!(parse_numeric_decimal("12 .5").is_none());
    }
    ...
    fn qualitative_with_diacritics_match() {
        assert_eq!(
            parse_qualitative_value("Não detectado"),
            Some("Não detectado")
        );
    }
    ...
    fn qualitative_reactivo_variants() {
        ...
        assert_eq!(
            parse_qualitative_value("Não Reactivo"),
            Some("Não Reactivo")
        );
