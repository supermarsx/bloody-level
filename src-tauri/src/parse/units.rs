...
static CANON: Lazy<HashMap<&'static str, &'static str>> = Lazy::new(|| {
    ...
    let pairs: &[(&[&str], &str)] = &[
        ...
        (&["x 10^3/µl", "x 103/µl", "× 10³/µL", "x 10^3/uL", "x10^3/uL"], "x 10^3/µL"),
        (&["x 10^6/µl", "x 106/µl", "× 10⁶/µL", "x 10^6/uL", "x10^6/uL"], "x 10^6/µL"),
        // Truncated form used in leucograma sub-rows where µl is implicit
        // from the parent Leucócitos row.
        (&["x 10^3/", "x 103/"], "x 10^3/µL"),
        (&["ml/min/1,73 m2", "mL/min/1.73 m²", "ml/min/1.73m2"], "mL/min/1.73 m²"),
    ];
...
mod tests {
    ...
    #[test] fn canonicalizes_g_dl() { assert_eq!(normalize_unit("g/dl"), Some("g/dL")); }
    #[test] fn canonicalizes_mg_dl() { assert_eq!(normalize_unit("mg/dL"), Some("mg/dL")); }
    #[test] fn canonicalizes_truncated_leuco() { assert_eq!(normalize_unit("x 10^3/"), Some("x 10^3/µL")); }
}
