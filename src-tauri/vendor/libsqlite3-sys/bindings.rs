...
pub const SQLITE3MC_VERSION_RELEASE: i32 = 4;
pub const SQLITE3MC_VERSION_SUBRELEASE: i32 = 0;
pub const SQLITE3MC_VERSION_STRING: &::std::ffi::CStr = c"SQLite3 Multiple Ciphers 2.2.4";
...
pub const SQLITE_SOURCE_ID: &::std::ffi::CStr =
    c"2025-07-30 19:33:53 4d8adfb30e03f9cf27f800a2c1ba3c48fb4ca1b08b0f5ed59a4d5ecbf45e20a3";
...
pub const CODEC_TYPE_UNKNOWN: i32 = 0;
pub const CODEC_TYPE_AES128: i32 = 1;
pub const CODEC_TYPE_AES256: i32 = 2;
pub const CODEC_TYPE_CHACHA20: i32 = 3;
pub const CODEC_TYPE_SQLCIPHER: i32 = 4;
pub const CODEC_TYPE_RC4: i32 = 5;
pub const CODEC_TYPE_ASCON128: i32 = 6;
pub const CODEC_TYPE_AEGIS: i32 = 7;
pub const CODEC_TYPE_MAX_BUILTIN: i32 = 7;
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn sqlite3mc_cipher_count() -> ::std::os::raw::c_int;
}
unsafe extern "C" {
    pub fn sqlite3mc_cipher_index(
        cipherName: *const ::std::os::raw::c_char,
    ) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
    pub fn sqlite3mc_cipher_name(
        cipherIndex: ::std::os::raw::c_int,
    ) -> *const ::std::os::raw::c_char;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn sqlite3mc_config_cipher(
        db: *mut sqlite3,
        cipherName: *const ::std::os::raw::c_char,
        paramName: *const ::std::os::raw::c_char,
        newValue: ::std::os::raw::c_int,
...
unsafe extern "C" {
    pub fn sqlite3mc_version() -> *const ::std::os::raw::c_char;
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct _CipherParams {
    pub m_name: *const ::std::os::raw::c_char,
    pub m_value: ::std::os::raw::c_int,
    pub m_default: ::std::os::raw::c_int,
    pub m_minValue: ::std::os::raw::c_int,
    pub m_maxValue: ::std::os::raw::c_int,
}
pub type CipherParams = _CipherParams;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct BtShared {
    _unused: [u8; 0],
}
pub type BtSharedMC = BtShared;
pub type AllocateCipher_t =
    ::std::option::Option<unsafe extern "C" fn(db: *mut sqlite3) -> *mut ::std::os::raw::c_void>;
pub type FreeCipher_t =
    ::std::option::Option<unsafe extern "C" fn(cipher: *mut ::std::os::raw::c_void)>;
pub type CloneCipher_t = ::std::option::Option<
    unsafe extern "C" fn(
        cipherTo: *mut ::std::os::raw::c_void,
        cipherFrom: *mut ::std::os::raw::c_void,
    ),
>;
pub type GetLegacy_t = ::std::option::Option<
    unsafe extern "C" fn(cipher: *mut ::std::os::raw::c_void) -> ::std::os::raw::c_int,
>;
pub type GetPageSize_t = ::std::option::Option<
    unsafe extern "C" fn(cipher: *mut ::std::os::raw::c_void) -> ::std::os::raw::c_int,
>;
pub type GetReserved_t = ::std::option::Option<
    unsafe extern "C" fn(cipher: *mut ::std::os::raw::c_void) -> ::std::os::raw::c_int,
>;
pub type GetSalt_t = ::std::option::Option<
    unsafe extern "C" fn(cipher: *mut ::std::os::raw::c_void) -> *mut ::std::os::raw::c_uchar,
>;
pub type GenerateKey_t = ::std::option::Option<
    unsafe extern "C" fn(
        cipher: *mut ::std::os::raw::c_void,
        userPassword: *mut ::std::os::raw::c_char,
        passwordLength: ::std::os::raw::c_int,
        rekey: ::std::os::raw::c_int,
        cipherSalt: *mut ::std::os::raw::c_uchar,
    ),
>;
pub type EncryptPage_t = ::std::option::Option<
    unsafe extern "C" fn(
        cipher: *mut ::std::os::raw::c_void,
...
>;
pub type DecryptPage_t = ::std::option::Option<
    unsafe extern "C" fn(
        cipher: *mut ::std::os::raw::c_void,
        page: ::std::os::raw::c_int,
        data: *mut ::std::os::raw::c_uchar,
        len: ::std::os::raw::c_int,
        reserved: ::std::os::raw::c_int,
        hmacCheck: ::std::os::raw::c_int,
    ) -> ::std::os::raw::c_int,
>;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct _CipherDescriptor {
    pub m_name: *const ::std::os::raw::c_char,
    pub m_allocateCipher: AllocateCipher_t,
    pub m_freeCipher: FreeCipher_t,
    pub m_cloneCipher: CloneCipher_t,
    pub m_getLegacy: GetLegacy_t,
    pub m_getPageSize: GetPageSize_t,
    pub m_getReserved: GetReserved_t,
    pub m_getSalt: GetSalt_t,
    pub m_generateKey: GenerateKey_t,
    pub m_encryptPage: EncryptPage_t,
    pub m_decryptPage: DecryptPage_t,
}
pub type CipherDescriptor = _CipherDescriptor;
unsafe extern "C" {
    pub fn sqlite3mc_register_cipher(
        desc: *const CipherDescriptor,
        params: *const CipherParams,
        makeDefault: ::std::os::raw::c_int,
    ) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
    pub fn sqlite3mcCheckVfs(zVfs: *const ::std::os::raw::c_char) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
    pub fn sqlite3mc_vfs_create(
        zVfsReal: *const ::std::os::raw::c_char,
        makeDefault: ::std::os::raw::c_int,
    ) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
    pub fn sqlite3mc_vfs_destroy(zName: *const ::std::os::raw::c_char);
}
unsafe extern "C" {
    pub fn sqlite3mc_vfs_shutdown();
}
